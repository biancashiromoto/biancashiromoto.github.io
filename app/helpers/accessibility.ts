export const getAriaLabel = (isLanguagePortuguese: boolean) => ({
  button: {
    scrollDown: isLanguagePortuguese
      ? "Botão para rolar para baixo"
      : "Scroll down button",
    scrollUp: isLanguagePortuguese
  ...
  links: {
    opensInANewTab: isLanguagePortuguese
      ? "Abre em uma nova guia"
      : "Opens in a new tab",
    linkedin: isLanguagePortuguese
      ? "Visite meu perfil no LinkedIn"
      : "Visit my LinkedIn profile",
    github: isLanguagePortuguese
      ? "Visite meu perfil no GitHub"
      : "Visit my GitHub profile",
    email: isLanguagePortuguese ? "Enviar email para" : "Send email to",
    pageDown: isLanguagePortuguese
      ? "Ir para a próxima página"
      : "Go to next page",
    pageUp: isLanguagePortuguese
      ? "Voltar à página anterior"
      : "Go back to the previous page",
    resume: isLanguagePortuguese
  ...
  pages: {
    projects: isLanguagePortuguese
      ? "Ir para a página de Projetos"
      : "Go to Projects page",
    return: isLanguagePortuguese
      ? "Voltar à página anterior"
